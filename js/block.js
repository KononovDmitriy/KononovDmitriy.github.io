...
/***/ (function(module, exports, __webpack_require__) {
	...
	loginForm.addEventListener('submit', function (event) {
	  ...
	  if (numberSubmit > 4 && window.captchaOnLoad) {
	    captchaId = _captcha2.default.getCaptcha(captchaCallback);
	  } else {
	    _login2.default.submit(inputFields.login.value, inputFields.password.value);
	  }
	});
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  getCaptcha: function getCaptcha(callback) {
	    if (window.captchaOnLoad) {
	      return window.grecaptcha.render('loginButtonSubmit', {
