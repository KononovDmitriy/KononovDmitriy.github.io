...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setGlobalAlert = function setGlobalAlert(msg) {
	  globalAlert.innerHTML = globalAlert.innerHTML + ('<div id="globalAlert" class="alert alert-warning alert-danger fade show" role="alert">\n      <strong>\u041E\u0428\u0418\u0411\u041A\u0410! </strong> ' + msg + '\n      <button type="button" class="close" data-dismiss="alert" aria-label="Close">\n        <span aria-hidden="true">&times;</span>\n      </button>\n    </div>');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var callbackXhrSuccess = function callbackXhrSuccess(response) {
	  ...
	  if (response.status === 200) {
	    ...
	    _main_login_window2.default.setAlert(response.message);
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var captchaErrorCallback = function captchaErrorCallback(response) {
	  ...
	  _main_login_window2.default.setAlert('Ошибка соединения с сервером капчи');
	};
