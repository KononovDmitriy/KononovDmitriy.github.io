...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BUTTON_SUBMIT_ID = 'registerButtonSubmit';
	var captchaId = void 0;
	
	var captchaCallback = function captchaCallback() {
	
	  console.log('register catcha id = ' + captchaId);
	  window.grecaptcha.reset(captchaId);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BUTTON_SUBMIT_ID = 'emailConfirmButtonSubmit';
	var captchaId = void 0;
	
	var captchaCallback = function captchaCallback() {
	
	  console.log('confirm catcha id = ' + captchaId);
	  window.grecaptcha.reset(captchaId);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BUTTON_SUBMIT_ID = 'forgotButtonSubmit';
	var captchaId = void 0;
	
	var captchaCallback = function captchaCallback() {
	
	  console.log('forgot catcha id = ' + captchaId);
	  window.grecaptcha.reset(captchaId);
