...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _form_login = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./form_login.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _form_login2 = _interopRequireDefault(_form_login);
	
	var _form_register = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./form_register.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _form_register2 = _interopRequireDefault(_form_register);
	
	var _form_confirm_email = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./form_confirm_email.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _form_confirm_email2 = _interopRequireDefault(_form_confirm_email);
	
	var _form_forgot = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./form_forgot.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
